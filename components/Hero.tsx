...
function Typewriter({ texts }: { texts: string[] }) {
  ...
  return (
    <h2 className="font-sans text-xl md:text-2xl text-white/80 mt-1 h-8" aria-label="Desenvolvedora Web">
  ...
  return (
    ...
    >
      <div className="relative w-80 h-80 md:w-[26rem] md:h-[26rem]">
        <div className="absolute inset-0 rounded-full border border-[#00ff87]/20" style={{ boxShadow: "0 0 40px rgba(0,255,135,0.06)" }} />
        <motion.div
    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center pt-20 overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="relative max-w-7xl mx-auto w-full px-8 py-12 flex flex-col md:flex-row items-center gap-16 md:px-20 md:py-16">
        <div className="flex-1 flex flex-col gap-6">
          ...
          <FadeUp delay={0.2}>
            <p className="font-mono text-base tracking-[0.15em] text-[#00ff87]/60 lowercase mb-1" aria-hidden="true">olá, eu sou</p>
            <h1 id="hero-heading" className="font-sans font-bold text-white leading-tight" style={{ fontSize: "clamp(2.5rem, 6vw, 4rem)" }}>
              Ana{" "}
              <span className="text-[#00ff87]" style={{ textShadow: "0 0 30px rgba(0,255,135,0.5), 0 0 60px rgba(0,255,135,0.2)" }}>Ananias</span>
            </h1>
          ...
          <FadeUp delay={0.3}>
            <p className="font-sans text-base leading-7 text-white/40 max-w-md">
              Apaixonada por interfaces bem feitas. Transformo ideias em experiências digitais com tecnologias modernas, sempre com atenção aos detalhes e amor pelo que faço.
            </p>
          </FadeUp>
          ...
          <FadeUp delay={0.5}>
            <nav className="flex gap-3" aria-label="Redes">
              <a href="https://github.com/anaflgg" target="_blank" rel="noopener noreferrer" aria-label="GitHub da Ana" className="p-2.5 rounded-md border border-[#00ff87]/20 text-[#00ff87]/50 hover:text-[#00ff87] hover:border-[#00ff87]/50 hover:bg-[#00ff87]/5 transition-all duration-200">
              ...
              <a href="https://www.linkedin.com/in/anaflgg/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn da Ana" className="p-2.5 rounded-md border border-[#00ff87]/20 text-[#00ff87]/50 hover:text-[#00ff87] hover:border-[#00ff87]/50 hover:bg-[#00ff87]/5 transition-all duration-200">
      ...
      <p className="relative text-center font-mono text-xs text-[#00ff87]/20 pb-8 tracking-[0.05em]" aria-hidden="true">scroll para ver mais ↓</p>
    </section>
  );
}
